...
let 
  inherit (nixpkgs) lib stdenv fetchFromGitHub pkg-config cmake flex cadical symfpu gmp python3 gtest libantlr3c antlr3_4 boost jdk;
in
stdenv.mkDerivation rec {
  ...
  configureFlags = ["--python-bindings"];
